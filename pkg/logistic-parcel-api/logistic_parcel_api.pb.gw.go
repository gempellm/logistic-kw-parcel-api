...
// RegisterLogisticParcelApiServiceHandlerServer registers the http handlers for service LogisticParcelApiService to "mux".
// UnaryRPC     :call LogisticParcelApiServiceServer directly.
...
// RegisterLogisticParcelApiServiceHandlerFromEndpoint is same as RegisterLogisticParcelApiServiceHandler but
...
func RegisterLogisticParcelApiServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterLogisticParcelApiServiceHandler(ctx, mux, conn)
}

// RegisterLogisticParcelApiServiceHandler registers the http handlers for service LogisticParcelApiService to "mux".
...
func RegisterLogisticParcelApiServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterLogisticParcelApiServiceHandlerClient(ctx, mux, NewLogisticParcelApiServiceClient(conn))
}

// RegisterLogisticParcelApiServiceHandlerClient registers the http handlers for service LogisticParcelApiService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "LogisticParcelApiServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "LogisticParcelApiServiceClient"
